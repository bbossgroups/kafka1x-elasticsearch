...
//				.setUsePool(true)//是否使用连接池
		...
		//bin/kafka-console-producer.sh --broker-list 10.103.11.12:9092 --topic xinkonglog
		/**
		 * 发送测试数据
		...
		Kafka1InputConfig kafka1InputConfig = new Kafka1InputConfig();
		kafka1InputConfig//.addKafkaConfig("value.deserializer","org.apache.kafka.common.serialization.StringDeserializer")
...
//				.addKafkaConfig("bootstrap.servers","192.168.137.133:9093")
		...
		importBuilder.setInputConfig(kafka1InputConfig);
